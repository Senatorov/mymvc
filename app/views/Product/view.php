        ...
        <div class="single-main">
            <div class="col-md-9 single-main-left">
                <div class="sngl-top">
                    ...
                    <?php
                        $curr = \myframework\App::$app->getProperty('currency');
                        $cats = \myframework\App::$app->getProperty('cats');
                    ?>
                        ...
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <ul class="tag-men">
                                <li><span>CATEGORY</span>
                                    <span>:
                                        <a href="category/<?= $cats[$product->category_id]['alias'] ?>" style="display: inline-block; margin: 0 0 0 20px; font-size: 15px">
                            ...
                            <a id="productAdd" data-id="<?= $product->id ?>" href="cart/add?=<?= $product->id ?>" class="add-cart item_add add-to-cart-link">ADD TO CART</a>
